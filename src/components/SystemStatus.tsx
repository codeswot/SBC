    ...
    <div className="bg-white rounded-2xl shadow-lg p-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        ...
        <div className="bg-purple-50 p-4 rounded-lg text-center border-2 border-purple-400">
          ...
          <p className="text-xs text-gray-600">Output <span className="text-[10px] text-gray-400">(auto)</span></p>
          <input
            type="number"
            value={status.outputVoltage}
            readOnly
            className="w-full text-2xl font-bold text-purple-600 bg-transparent text-center mt-1 border-b border-purple-300 focus:outline-none cursor-not-allowed"
          />
          <p className="text-xs text-gray-500 mt-1">V</p>
        </div>
      </div>
